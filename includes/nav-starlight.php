    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="dashbroad.php" class="sl-menu-link">
        ...
        <a href="setting.php" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Text Setting</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="skill.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-gear-outline tx-24"></i>
            <span class="menu-item-label">About Skill</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="service.php" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            <span class="menu-item-label">Service, Fact, Contact</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        ...
        <a href="work.php" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name"><?=$_SESSION['full_name_from_login_page']?></span>
              <img src="image/profile image/<?=$_SESSION['profile_image_from_login_page']?>" class="wd-32 rounded-circle" alt="">
            </a>
